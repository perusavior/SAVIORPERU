    ...
    return (
      <section className='flex w-full h-full min-h-[70vh] justify-center items-center'>
        <div className='w-[380px] animate-pulse'>
          ...
          <div className='h-12 bg-gray-100 rounded-lg flex items-center px-4 mb-6'>
          ...
          <div className='mb-6'>
            ...
            <div className='h-3 bg-gray-100 rounded w-40 mt-1'></div>
          </div>
      ...
      <SignIn
        appearance={{
          elements: {
            ...
            headerSubtitle: '',
            formFieldInput:
              'h-12 px-4 text-base border border-gray-300 focus:outline-none focus:ring-0',
